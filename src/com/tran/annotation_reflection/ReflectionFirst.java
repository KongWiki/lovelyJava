...
public class ReflectionFirst {
    public static void main(String[] args) throws ClassNotFoundException {
        Class<?> aClass = Class.forName("com.tran.annotation_reflection.ReflectionFirst");
        System.out.println(aClass);
        Class<?> bClass = Class.forName("com.tran.annotation_reflection.ReflectionFirst");
        Class<?> cClass = Class.forName("com.tran.annotation_reflection.ReflectionFirst");
        // 一个类在内存中只有一个Class
        ...
        Class<?> aClass3 = Class.forName("com.tran.annotation_reflection.User");
